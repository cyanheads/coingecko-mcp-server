...
#
# Pinned to $BUILDPLATFORM: the build output is platform-independent JS and only
# dist/ is copied forward, so the build always runs natively instead of under
# QEMU emulation (where Bun can abort with MemoryExhaustion on linux/amd64).
# ==============================================================================
...
ARG APP_VERSION
LABEL org.opencontainers.image.title="coingecko-mcp-server"
LABEL org.opencontainers.image.description="Market data for 15,000+ cryptocurrencies — prices, history, trends, and deep coin metadata via CoinGecko."
LABEL org.opencontainers.image.licenses="Apache-2.0"
LABEL org.opencontainers.image.version="${APP_VERSION}"
LABEL org.opencontainers.image.source="https://github.com/cyanheads/coingecko-mcp-server"
...
RUN mkdir -p /var/log/coingecko-mcp-server && chown -R bun:bun /var/log/coingecko-mcp-server
...
ENV LOGS_DIR="/var/log/coingecko-mcp-server"
